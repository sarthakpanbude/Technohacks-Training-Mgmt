                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group btn-group-sm" role="group">
                                    <input type="radio" class="btn-check" name="statuses[<?php echo $i; ?>]" value="present" id="p<?php echo $s['id']; ?>" <?php echo ($curr == 'present' || $curr == '') ? 'checked' : ''; ?>>
                                    <label class="btn btn-outline-success" for="p<?php echo $s['id']; ?>">Present</label>

                                    <input type="radio" class="btn-check" name="statuses[<?php echo $i; ?>]" value="absent" id="a<?php echo $s['id']; ?>" <?php echo $curr == 'absent' ? 'checked' : ''; ?>>
                                    <label class="btn btn-outline-danger" for="a<?php echo $s['id']; ?>">Absent</label>

                                    <input type="radio" class="btn-check" name="statuses[<?php echo $i; ?>]" value="late" id="l<?php echo $s['id']; ?>" <?php echo $curr == 'late' ? 'checked' : ''; ?>>
                                    <label class="btn btn-outline-warning" for="l<?php echo $s['id']; ?>">Late</label>

                                    <input type="radio" class="btn-check" name="statuses[<?php echo $i; ?>]" value="leave" id="lv<?php echo $s['id']; ?>" <?php echo $curr == 'leave' ? 'checked' : ''; ?>>
